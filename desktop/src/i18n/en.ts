export const en = {
  ...
  update_auto_check_desc: "Automatically check for new versions on startup",
  ...
  update_status_available: "New version available",
  update_status_downloading: "Downloading update",
  update_status_installing: "Installing update, do not close the app",
  update_status_pending_restart: "Update installed, restart to apply",
  update_status_failed: "Update failed",
  update_available_title: "New Version Available",
  update_available_desc: "We recommend updating for the latest features and fixes",
  ...
  update_btn_view_details: "View Full Release Notes",
  update_btn_open_download: "Open Download Page",
  update_btn_restart: "Restart Now",
  update_download_speed: "Download Speed",
  update_download_size: "File Size",
  update_error_network: "Network connection failed",
  update_error_server: "Server configuration error",
  update_error_signature: "Security verification failed",
  update_error_unknown: "Unknown error",
  update_last_check: "Last Check",
